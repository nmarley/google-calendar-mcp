...
} from '../../../handlers/utils/datetime.js';
...
describe('Datetime Utilities', () => {
    describe('hasTimezoneInDatetime', () => {
        it('should return true for timezone-aware datetime strings', () => {
            ...
            expect(hasTimezoneInDatetime('2024-01-01T10:00:00+05:00')).toBe(
                true,
            );
            expect(hasTimezoneInDatetime('2024-01-01T10:00:00-08:00')).toBe(
                true,
            );
        });
    ...
    describe('convertToRFC3339', () => {
        it('should return timezone-aware datetime unchanged', () => {
            ...
            expect(convertToRFC3339(datetime, 'America/Los_Angeles')).toBe(
                datetime,
            );
        });
