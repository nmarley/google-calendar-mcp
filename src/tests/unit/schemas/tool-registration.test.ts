...
describe('Tool Registration', () => {
    ...
    beforeEach(() => {
        ...
        mockServer.registerTool = vi.fn(
            (name: string, definition: any, _handler: any) => {
    ...
    it('should register the correct number of tools', async () => {
        await ToolRegistry.registerAll(mockServer, async () => ({
            content: [],
        }));
    ...
    it('should properly extract schema for update-event tool with .refine() methods', async () => {
        ...
        const updateEventTool = registeredTools.find(
            (t) => t.name === 'update-event',
        );
    ...
    it('should compare update-event with create-event to ensure both have proper schemas', async () => {
        ...
        const createEventTool = registeredTools.find(
    ...
    it('should catch schema extraction issues early', async () => {
        ...
        const extractedShape = (ToolRegistry as any).extractSchemaShape(
            updateEventSchema,
        );
